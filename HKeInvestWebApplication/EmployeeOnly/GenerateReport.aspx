...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:Label runat="server" Text="Account Number" AssociatedControlID="AccountNumber"></asp:Label><asp:TextBox ID="AccountNumber" runat="server" MaxLength="10"></asp:TextBox>
    </div>
    <div>
