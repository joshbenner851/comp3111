            ...
            <div >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:RequiredFieldValidator ControlToValidate="cbTitle" runat="server" ErrorMessage="Please type First Name" Text="*" Display="Dynamic" CssClass="text-danger" EnableClientScript="false"></asp:RequiredFieldValidator>
                    </div>
